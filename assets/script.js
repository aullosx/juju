...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
           case "19/6": titulo = "12 de maio de 2026"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>Este momento está sendo escrito agora...</strong></p></section>";break;
            case "final": titulo = "12 de maio de 2026"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
